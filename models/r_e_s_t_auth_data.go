...
// RESTAuthData r e s t auth data
//
...
// Validate validates this r e s t auth data
...
// ContextValidate validate this r e s t auth data based on the context it is used
func (m *RESTAuthData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RESTAuthData) contextValidateToken(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RESTAuthData) contextValidatePassword(ctx context.Context, formats strfmt.Registry) error {
