...
// RESTWorkloadV2 r e s t workload v2
//
// swagger:model RESTWorkloadV2
...
// Validate validates this r e s t workload v2
func (m *RESTWorkloadV2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RESTWorkloadV2) validateBrief(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validateChildren(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validateEnforcerID(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validateEnforcerName(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validateExitCode(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validateFinishedAt(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validatePlatformRole(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validateRtAttributes(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validateRunning(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validateSecuredAt(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validateSecurity(formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) validateStartedAt(formats strfmt.Registry) error {
...
// ContextValidate validate this r e s t workload v2 based on the context it is used
func (m *RESTWorkloadV2) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RESTWorkloadV2) contextValidateBrief(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) contextValidateChildren(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) contextValidateRtAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) contextValidateSecurity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RESTWorkloadV2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RESTWorkloadV2) UnmarshalBinary(b []byte) error {
	var res RESTWorkloadV2
