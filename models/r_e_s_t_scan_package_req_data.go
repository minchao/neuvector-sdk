...
// RESTScanPackageReqData r e s t scan package req data
//
...
// Validate validates this r e s t scan package req data
		...
		if m.ApplicationPackages[i] != nil {
			if err := m.ApplicationPackages[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("application_packages" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContextValidate validate this r e s t scan package req data based on the context it is used
func (m *RESTScanPackageReqData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RESTScanPackageReqData) contextValidateApplicationPackages(ctx context.Context, formats strfmt.Registry) error {
