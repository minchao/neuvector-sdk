...
// RESTScanReportData r e s t scan report data
//
...
// Validate validates this r e s t scan report data
...
// ContextValidate validate this r e s t scan report data based on the context it is used
func (m *RESTScanReportData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RESTScanReportData) contextValidateReport(ctx context.Context, formats strfmt.Registry) error {
