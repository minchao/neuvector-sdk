...
// RESTResponseRuleConfigData r e s t response rule config data
//
...
// Validate validates this r e s t response rule config data
...
// ContextValidate validate this r e s t response rule config data based on the context it is used
func (m *RESTResponseRuleConfigData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RESTResponseRuleConfigData) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
