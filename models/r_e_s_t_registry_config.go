...
// RESTRegistryConfig r e s t registry config
//
...
// Validate validates this r e s t registry config
...
func (m *RESTRegistryConfig) validatePassword(formats strfmt.Registry) error {
...
// ContextValidate validate this r e s t registry config based on the context it is used
func (m *RESTRegistryConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RESTRegistryConfig) contextValidateAwsKey(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RESTRegistryConfig) contextValidateGcrKey(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RESTRegistryConfig) contextValidateJfrogXray(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RESTRegistryConfig) contextValidateSchedule(ctx context.Context, formats strfmt.Registry) error {
