...
// RESTRegistryConfigData r e s t registry config data
//
...
// Validate validates this r e s t registry config data
...
// ContextValidate validate this r e s t registry config data based on the context it is used
func (m *RESTRegistryConfigData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RESTRegistryConfigData) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
