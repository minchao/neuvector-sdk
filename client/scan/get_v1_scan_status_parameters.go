...
// WithXAuthToken adds the xAuthToken to the get v1 scan status params
func (o *GetV1ScanStatusParams) WithXAuthToken(xAuthToken string) *GetV1ScanStatusParams {
	o.SetXAuthToken(xAuthToken)
	return o
}

// SetXAuthToken adds the xAuthToken to the get v1 scan status params
func (o *GetV1ScanStatusParams) SetXAuthToken(xAuthToken string) {
